...
export class PharmacyService {
  // Get medicines
  static async getMedicines(searchQuery = '', category = '') {
    return ApiService.get('/pharmacy/medicines', {
      search: searchQuery,
      category,
    });
  }
  ...
  // Add to cart
  static async addToCart(patientId, medicineId, quantity) {
    return ApiService.post('/pharmacy/cart', {
      patientId,
      medicineId,
      quantity,
    });
  ...
  static async getCart(patientId) {
    return ApiService.get(`/pharmacy/cart/${patientId}`);
  }

  // Place order
  static async placeOrder(patientId, orderData) {
    return ApiService.post('/pharmacy/orders', {
      patientId,
      ...orderData,
    });
  }
  ...
  static async getOrderHistory(patientId) {
    return ApiService.get(`/pharmacy/orders/${patientId}`);
  }
}