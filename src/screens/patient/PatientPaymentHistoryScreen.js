  ...
  const InvoiceCard = ({ invoice }) => (
    <View style={styles.card}>
      ...
      <View style={styles.cardHeader}>
        ...
        <View style={styles.cardInfo}>
          <Text style={styles.cardTitle}>{invoice.description || 'Invoice'}</Text>
          <Text style={styles.cardSubtitle}>{invoice.invoiceNumber}</Text>
          <Text style={styles.cardDate}>
            Issue: {invoice.issueDate || 'N/A'} • Due: {invoice.dueDate || 'N/A'}
          </Text>
          
          {/* Service Type & Auto-Gen Info */}
          {(invoice.serviceType || invoice.isAutoGenerated) && (
            <View style={styles.invoiceMetaContainer}>
              ...
              {invoice.isAutoGenerated && (
                <Text style={styles.autoGenInfo}>
                  From {invoice.generatedFrom === 'payment' ? 'Payment' : 'Registration'}
                </Text>
              )}
            </View>
          )}
